...
This page is automatically generated from [`odict.xsd`](https://github.com/TheOpenDictionary/odict/blob/main/odict.xsd) and
[`pos.rs`](https://github.com/TheOpenDictionary/odict/blob/main/lib/src/schema/pos.rs).
