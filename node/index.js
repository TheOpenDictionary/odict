...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      try {
        return require("./node.android-arm64.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
        ...
        if (
          bindingPackageVersion !== "2.2.2" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ) {
          throw new Error(
            `Native binding package version mismatch, expected 2.2.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
          );
        }
        return binding;
      } catch (e) {
    ...
    if (process.arch === "x64") {
      if (
        ...
        try {
          return require("./node.win32-x64-gnu.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
          const binding = require("@odict/node-win32-x64-gnu");
          const bindingPackageVersion = require("@odict/node-win32-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "2.2.2" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          return require("./node.win32-x64-msvc.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
      ...
      try {
        return require("./node.win32-ia32-msvc.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
      ...
      try {
        return require("./node.win32-arm64-msvc.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
    ...
    try {
      return require("./node.darwin-universal.node");
    } catch (e) {
      loadErrors.push(e);
    }
    try {
    ...
    if (process.arch === "x64") {
      try {
        return require("./node.darwin-x64.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
      ...
      try {
        return require("./node.darwin-arm64.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
    ...
    if (process.arch === "x64") {
      try {
        return require("./node.freebsd-x64.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
      ...
      try {
        return require("./node.freebsd-arm64.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        try {
          return require("./node.linux-x64-musl.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
        ...
        try {
          return require("./node.linux-x64-gnu.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
      ...
      if (isMusl()) {
        try {
          return require("./node.linux-arm64-musl.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
        ...
        try {
          return require("./node.linux-arm64-gnu.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
      ...
      if (isMusl()) {
        try {
          return require("./node.linux-loong64-musl.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
          const binding = require("@odict/node-linux-loong64-musl");
          const bindingPackageVersion =
            require("@odict/node-linux-loong64-musl/package.json").version;
          if (
            bindingPackageVersion !== "2.2.2" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          return require("./node.linux-loong64-gnu.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
          const binding = require("@odict/node-linux-loong64-gnu");
          const bindingPackageVersion =
            require("@odict/node-linux-loong64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "2.2.2" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        try {
          return require("./node.linux-riscv64-musl.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
        ...
        try {
          return require("./node.linux-riscv64-gnu.node");
        } catch (e) {
          loadErrors.push(e);
        }
        try {
      ...
      try {
        return require("./node.linux-ppc64-gnu.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
      ...
      try {
        return require("./node.linux-s390x-gnu.node");
      } catch (e) {
        loadErrors.push(e);
      }
      try {
