...
cli-build:
	env $(cat versions.txt | xargs) go build -ldflags "-X 'github.com/TheOpenDictionary/odict/cli.version=${CLI}' -X 'github.com/TheOpenDictionary/odict/go.version=${FILE}'" -o ./bin/odict ./odict.go
