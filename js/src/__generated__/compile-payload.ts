...
static createCompilePayload(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, pathOffset:flatbuffers.Offset, outOffset:flatbuffers.Offset):flatbuffers.Offset {
  CompilePayload.startCompilePayload(builder);
  CompilePayload.addId(builder, idOffset);
