...
Compiled .odict files are relatively straightforward, as they utilize the [ODict Flatbuffer schema](./flatbuffers/schema.fbs).
...
For an example of how the files are written, you can look at the official [Go code that does so](./lib/core/read.go).
